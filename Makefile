...
clean:
	rm -rf *.dSYM *o $(EXECUTABLE_TEMPLATE_MATCHING) $(EXECUTABLE_TEMPLATE_MATCHING_WTB) $(EXECUTABLE_TEMPLATE_MATCHING_JSON) $(EXECUTABLE_EXTRACT_CONTOURS) $(EXECUTABLE_EXTRACT_CONTOURS_TO_MOSAIC) $(COMPARE_CONTOURS) 
